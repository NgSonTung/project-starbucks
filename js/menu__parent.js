async function openMenu() {
    let value = "blur(5px)";
    ["container","this-is-header","this-is-footer"].forEach(e => {
...
async function closeMenu() {
    ...
    document.getElementsByClassName("bar1")[1].style.transform = "rotate(0) translate(0)";
    document.getElementsByClassName("bar2")[1].style.opacity = 1;
    document.getElementsByClassName("bar3")[1].style.transform = "rotate(0) translate(0)";
    await new Promise(resolve => setTimeout(resolve, 50));
